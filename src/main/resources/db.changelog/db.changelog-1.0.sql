...
INSERT INTO intern.`user`
(created_by, created_date, email, password, status, username)
VALUES('ADMIN',SYSDATE() ,"email@gmail.com","$2a$10$slBW/ZjbA2fP/Xc06i0x8ui6GTk58R/Ar.lvNr4EO.wQhngtEHKXe","1", "ADMIN");
